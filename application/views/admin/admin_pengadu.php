      ...
      <div class="card shadow mb-4">
          <div class="card-header py-3">
              <div class="d-flex align-text-center">
                  <h5 class="m-0 font-weight-bold text-info">Data Pengaduan</h5>
              </div>
          </div>
          <div class="card-body">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  ...
                                  <!-- Modal -->
                                  <div class="modal fade" id="detail<?= $p['id_pengaduan'] ?>" tabindex="-1"
                                      ...
                                      <div class="modal-dialog modal-lg">
                                          <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                  <form method="post"
                                                      action="<?= base_url('Admin/upload_pengaduan/') . $p['id_pengaduan'] ?>">
                                                      <fieldset disabled>
                                                          <div class="row">
                              ...
                              <td>
                                  ...
                                  <button type="button" class="btn btn-danger" data-toggle="modal"
                                      data-target="#ngadu<?= $p['id_pengaduan'] ?>">
                                      Tindakan
                                  </button>
                                  <?php endif ?>
                                  <?php if ($p['status'] == "proses") : ?>
                                  <a type="button" class="btn btn-warning"
                                      href="<?=base_url('Admin/statusproses/').$p['id_pengaduan'] ?>">
                                      Proses
                                  </a>
                                  <?php endif ?>
                                  ...
                                  <!-- status pengaduan -->
                                  <div class="modal fade" id="ngadu<?= $p['id_pengaduan'] ?>" tabindex="-1"
                                      aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog modal-lg">
                                          <div class="modal-content">
                                              <div class="modal-header">
                                                  ...
                                                  <form method="post"
                                                      ...
                                                      <div class="mb-3">
                                                          ...
                                                          <textarea class="form-control" name="tanggapan" id="tanggapan"
                                                              placeholder="Masukan Tanggapan"></textarea>
                                                      </div>
                                                      <div>
                                                          <label for="exampleInputEmail1"

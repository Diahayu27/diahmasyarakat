                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="<?= base_url('Auth/admin_setup') ?>">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="telp" name="telp"
                                        placeholder="telp">
                                ...
                                <button href="<?= base_url('Auth') ?>" type="submit"
